...
## Description
The long waited plugin for the Switcher boiler/water-heater is here!
...
*it is required to have static IP for the Switcher for the stored configurations to work.
